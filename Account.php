...
<body>
    ...
    <table id="account-table">
        ...
        <tr>
            ...
            <td>12345</td>
            <td>
                last login 02.45 am logout 14.00 pm 
                <span class="action-text" onclick="editRow(this)">edit</span> 
                <span class="action-text" onclick="removeRow(this)">remove</span>
            </td>
        </tr>
        <tr>
            <td>syahdan daud</td>
    ...
    <script>
        ...
        function editRow(element) {
            ...
            // Implementasi fungsi edit dapat dilakukan di sini
        }
    </script>
</body>
</html>
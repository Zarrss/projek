...
<body>
    ...
    $sql = "SELECT * FROM tsf_data WHERE deleted_at IS NULL";
    ...
    <ul class="nav">
        ...
        <li class="nav-item navbar-right">
            ...
            <table id="dataTable" class="editable-table">
                ...
                <tfoot>
            <tr>
                <td colspan="11">Tables : <?php echo $result->num_rows; ?></td>
            </tr>
        </tfoot>
            </table>
        </div>  
        ...
        <div id="floatingButtons" class="floating-buttons" style="display: none;">
            <button id="insertBtn" class="insert-btn">Insert</button>
            <button id="deactivateBtn" class="deactivate-btn">Deactivate</button>
        </div>
    ...
    <div class="sBar">
        <ul>
            <li><a href="#"><i class="fas fa-home"></i><span>Big Project</span></a></li>
            <li><a href="#"><i class="fas fa-info-circle"></i><span>Small Project</span></a></li>
            <li><a href="#"><i class="fas fa-cogs"></i><span>Project Engineer</span></a></li>
        </ul>
    </div>
    ...
    <div class="sidebar">
        <ul class="menu">
            <li class="menu-item active"><span class="icon user-icon"></span><span class="text">manager 1</span></li>
            <li class="menu-item"><span class="icon chart-icon"></span><span class="text">manager 2</span></li>
            <li class="menu-item"><span class="icon docs-icon"></span><span class="text">manager 3</span></li>
            <li class="menu-item"><span class="icon setting-icon"></span><span class="text">manager 4</span></li>
        </ul>
    </div>
